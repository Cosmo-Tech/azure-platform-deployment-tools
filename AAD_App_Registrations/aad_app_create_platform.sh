...
app=$(az ad app create --display-name "Cosmo Tech platform for $CUSTOMER" --app-roles @platform_app_roles_manifest.json --available-to-other-tenants --oauth2-allow-implicit-flow true)
...
az ad app permission grant --id $appId --api $appId
echo
