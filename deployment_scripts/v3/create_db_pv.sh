...
curl -sSL https://raw.githubusercontent.com/Cosmo-Tech/azure-platform-deployment-tools/main/deployment_scripts/v3/redis_pv-template.yaml -o redis_pv-template.yaml
